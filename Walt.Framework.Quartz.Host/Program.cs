                                    ...
                                    foreach (var item in listQuartzTask)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if ((OperateStatus)item.OperateStatus != OperateStatus.Stop)
                                            {
                                                ...
                                                {
                                                    var assembly = 
                                                    AssemblyHelp.GetAssemblyByteByAssemblyName(Path.Combine(Directory.GetCurrentDirectory(), "AssemblyColl"), assemblyName);
                                                   
                                                    jobTaskType = AssemblyHelp.GetTypeByAssemblyNameAndClassName(assembly, className);
                                                }
                                                catch (Exception ep)
                                                {
